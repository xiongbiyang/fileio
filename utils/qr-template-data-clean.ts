...
export function getTemplateGuide(templateKey: string | null, isZh: boolean) {
  ...
  const guideMap: Record<string, { summary: string; steps: string[] }> = {
    ...
    review: { summary: isZh ? '粘贴你的 Google 评论链接即可。' : 'Paste your Google review URL directly.', steps: isZh ? ['1. 复制评论链接', '2. 替换示例 URL', '3. 手机扫码验证跳转'] : ['1. Copy review URL from business profile', '2. Replace sample URL', '3. Test scan on phone'] },
