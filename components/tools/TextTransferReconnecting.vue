<template>
  <!-- Overlay only — the parent (transfer.vue) keeps TextTransferWaiting mounted
       underneath so the QR canvas stays visible through the blur. -->
  <div class="absolute inset-0 z-40 flex items-center justify-center backdrop-blur-[2px]">
    <div class="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-4 animate-bounce">
