  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Open FileIO on both devices, scan the QR code, and send files directly over an encrypted peer-to-peer connection.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'FileIO provides a browser-based AirDrop alternative that works across iPhone, Android, Windows, and macOS without installing an app.',
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. FileIO uses direct browser-to-browser WebRTC transfer with end-to-end encryption, and the service is designed so transfer content is not visible to FileIO servers.',
      },
    },
  ],
})
useJsonLd({
  ...
  description: 'Use FileIO WebRTC pairing to send files directly between devices in the browser.',
  totalTime: 'PT1M',
  step: [
    {
      '@type': 'HowToStep',
