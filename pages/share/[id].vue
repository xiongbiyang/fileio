<template>
  <div class="max-w-xl mx-auto px-6 py-10 md:py-16">
...
function triggerDownload() {
  ...
  // as a native file save. After a short delay we reset the spinner — the
  // actual transfer continues in the background handled by the browser.
