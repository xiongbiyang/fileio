...
With [FileIO's File Transfer tool](/transfer), you can transfer files directly between devices using your browser:
...
1. Go to [fileio.top/transfer](/transfer)
...
Ready to transfer files? Open the [File Transfer tool](/transfer) and try it — it takes less than 10 seconds to set up.
