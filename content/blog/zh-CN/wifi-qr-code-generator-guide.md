...
## 为什么使用 a WiFi QR Code

- No manual password typing
- Fewer input errors
- Faster onboarding for guests
- Great for cafes, studios, and rentals
...
- Use high contrast colors for better scan rate
- Keep code at least 3x3 cm when printed
