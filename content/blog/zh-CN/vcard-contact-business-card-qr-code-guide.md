...
## How to Generate a Business Card QR Code

1. Create your contact link or vCard content
2. Open [ToolPort QR Code Generator](/tools/qr-code?template=vcard)
3. Generate and style with your brand palette
4. Export SVG for print cards, PNG for digital

## Branding Advice

- Use your brand color but keep contrast high
